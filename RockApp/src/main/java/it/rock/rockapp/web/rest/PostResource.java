...
import it.rock.rockapp.repository.PostRepository;
import it.rock.rockapp.service.PostService;
...
/**
 * REST controller for managing {@link it.rock.rockapp.domain.Post}.
 */
@RestController
@RequestMapping("/api")
